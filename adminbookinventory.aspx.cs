...
namespace ElibManagement
{
    public partial class adminbookinventory : System.Web.UI.Page
    {
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            {
                Response.Write("<script>alert('Book Already Exists, try some other Book ID or Book Name');</script>");
            }
            else
            {
                addNewBook();
        ...
        void deleteBookByID()
        {
            if (checkIfBookExists())
            {
                try
                {
                    ...
                    SqlCommand cmd = new SqlCommand("DELETE from book_master_tbl1 WHERE book_id='" + TextBox1.Text.Trim() + "'", con);
        ...
        void updateBookByID()
        {
            ...
            if (checkIfBookExists())
            {
                try
                {
                    ...
                    SqlCommand cmd = new SqlCommand("UPDATE book_master_tbl1 set book_name=@book_name, genre=@genre, author_name=@author_name, publisher_name=@publisher_name, publish_date=@publish_date, language=@language, edition=@edition, book_cost=@book_cost, no_of_pages=@no_of_pages, book_description=@book_description, actual_stock=@actual_stock, current_stock=@current_stock, book_img_link=@book_img_link where book_id='" + TextBox1.Text.Trim() + "'", con);
        ...
        void getBookByID()
        {
            try
            {
                ...
                SqlCommand cmd = new SqlCommand("SELECT * from book_master_tbl1 WHERE book_id='" + TextBox1.Text.Trim() + "';", con);
        ...
        bool checkIfBookExists()
        {
            try
            {
                ...
                SqlCommand cmd = new SqlCommand("SELECT * from book_master_tbl1 where book_id='" + TextBox1.Text.Trim() + "' OR book_name='" + TextBox2.Text.Trim() + "';", con);
                SqlDataAdapter da = new SqlDataAdapter(cmd);
                DataTable dt = new DataTable();
                da.Fill(dt);
        ...
        void addNewBook()
        {
            try
            {
                ...
                SqlCommand cmd = new SqlCommand("INSERT INTO book_master_tbl1(book_id,book_name,genre,author_name,publisher_name,publish_date,language,edition,book_cost,no_of_pages,book_description,actual_stock,current_stock,book_img_link) values(@book_id,@book_name,@genre,@author_name,@publisher_name,@publish_date,@language,@edition,@book_cost,@no_of_pages,@book_description,@actual_stock,@current_stock,@book_img_link)", con);
